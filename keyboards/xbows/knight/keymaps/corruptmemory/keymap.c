...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |---------------------------------------------------------------------------------------------------------------------------------|
   * |Ctrl | GUI |     Alter   |  Backspace |   Ctrl   |   Enter   |     Space     |    Alter   |  FN  | Ctrl | Lft  |  Dn |  Rig |
   * |---------------------------------------------------------------------------------------------------------------------------------|
   */
  [0] = LAYOUT(
		...
		KC_CAPS, MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_S),MT(MOD_LALT, KC_D),MT(MOD_LGUI, KC_F),   KC_G,    KC_BSPC, KC_H,   MT(MOD_LGUI, KC_J),MT(MOD_RALT, KC_K),MT(MOD_RCTL, KC_L),MT(MOD_RSFT, KC_SCOLON), KC_QUOT, KC_ENT,  KC_PGDN,
		KC_LSFT, KC_Z,              KC_X,              KC_C,              KC_V,                 KC_B,    KC_ENT,  KC_N,   KC_M,              KC_COMM,           KC_DOT,            KC_SLSH,                 KC_RSFT, KC_UP,
		KC_LCTL, KC_LGUI,           KC_LALT,           KC_BSPC,           MO(2),                                KC_ENT, KC_SPC,            KC_RALT,                              MO(1),                   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
  [1] = LAYOUT(
  ...
  [2] = LAYOUT(
    ...
    KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,   KC_NO,  KC_HOME,       KC_PGDN, KC_PGUP, KC_END, KC_NO,  KC_NO,   KC_NO,   KC_NO,
    KC_NO,   KC_LSFT, KC_LCTRL, KC_LALT, KC_LGUI,KC_NO,   KC_NO,  LCTL(KC_PGUP),  KC_LEFT,       KC_DOWN, KC_UP,   KC_RIGHT, KC_NO,   KC_NO,   KC_NO,
    KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,   KC_NO,  LCTL(KC_PGDN),  LGUI(KC_PGUP), LGUI(KC_PGDN),   KC_NO,   KC_NO,    KC_NO,   KC_NO,
